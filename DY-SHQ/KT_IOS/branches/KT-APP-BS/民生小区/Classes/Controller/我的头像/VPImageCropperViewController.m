...
-(UIImage *)getSubImage{
    ...
    //转换base－64
    //UIImage *_originImage = [UIImage imageNamed:smallImage];
    //UIImage *littleImage = [UIImage imageNamed:@"register-3.png"];
    
    NSData *_data = UIImageJPEGRepresentation(smallImage, 1.0f);
     ...
     */
    NSLog(@"===Encoded smallImage:\n%@", encodedImageStr);
    return smallImage;
}
- (void)shareEncodedImageStr:(NSString *)str{
