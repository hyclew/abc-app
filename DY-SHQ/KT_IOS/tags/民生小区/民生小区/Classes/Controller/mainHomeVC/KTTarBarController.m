...
-(instancetype) initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    if (self = [super initWithNibName:nibNameOrNil bundle:nibBundleOrNil])
    {
        ...
        KTlifeViewController *life = [self addControllerWithClass:[KTlifeViewController class] title:@"生活服务" nomalimage:@"icon-1x-01"selectedImage:@"icon-1x-1"];
        UINavigationController *lifeNav = [[UINavigationController alloc]initWithRootViewController:life];
        
        UIViewController *shops = [self addControllerWithClass:[UIViewController class] title:@"信誉商家" nomalimage:@"icon-1x-02" selectedImage:@"icon-1x-2"];
        UIViewController *service = [self addControllerWithClass:[UIViewController class] title:@"便捷服务" nomalimage:@"icon-1x-03" selectedImage:@"icon-1x-3"];
        UIViewController *circle = [self addControllerWithClass:[UIViewController class] title:@"我的圈子" nomalimage:@"icon-1x-04" selectedImage:@"icon-1x-4"];
