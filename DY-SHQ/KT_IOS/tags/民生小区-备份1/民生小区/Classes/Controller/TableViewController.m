...
//
    ...
    NSString *url = @"http://192.168.2.103:8090/water/waterinformations/1001/0/10";
    ...
    [manager GET:url parameters:nil success:^(AFHTTPRequestOperation *operation, id responseObject) {
        ...
        if ([[result objectForKey:@"errorCode"] isEqualToString:@"0000"]) {
            ...
            for (NSDictionary *dict in resultArr) {
                ...
                ws.publishTime = dict[@"publishTime"];
                ws.salePrice = dict[@"salePrice"];
               // ws.numbers = [dict[@"numbers"] integerValue];
                
               
               
                ws.unitPrice = dict[@"unitPrice"];
               
                ws.productUrl = dict[@"productUrl"];
