...
- (void)viewDidLoad {
   ...
   [self initCommonTools:scrollView];
...
- (void)initTopView
{
   ...
   searchBar.centerX = kScreenWidth*0.5 - 90;
   searchBar.centerY = 64*0.5;
   searchBar.width = 180;
   searchBar.height = 30;
   ...
   rightBtn.frame = CGRectMake(CGRectGetMaxX(searchBar.frame)+16, 27, 37, 37);
...
- (void)initCommonTools:(UIScrollView *)scrollView
{
    UIView *BGview = [[UIView alloc]init];
    CGFloat X = 0;
    CGFloat Y = 0;
    BGview.frame = CGRectMake(X, Y,kScreenWidth , 171);
    BGview.backgroundColor = [UIColor colorWithRed:255/255.0 green:255/255.0 blue:255/255.0 alpha:0];
   // NSArray *mingZi = [NSArray arrayWithObjects:@"洗车",@"送水",@"保洁",@"超市",@"家政",nil];
    ...
    for(int i=0;i<5;i++)
    {
        ...
        CGFloat x = margin + ((margin *2) + 30) * i;
        CGFloat y = 20;
        if(i>=3)
        {
            y = 90;
...
//        UIButton *iconButton = [[UIButton alloc] initWithFrame:CGRectMake(self.view.bounds.size.width/2-45, 65, 90, 90)];
//        [iconButton setBackgroundImage:[UIImage imageNamed:@""] forState:UIControlStateNormal];
...
//        [self.view addSubview:iconButton];
     ...
     //  lab.text = mingZi[i];
        ...
        lab.textColor = [UIColor colorWithRed:88/255.0 green:90/255.0 blue:97/255.0 alpha:1];
        lab.frame = CGRectMake(x - 20, y + 40 , 80, 26);
        
        [BGview addSubview:lab];
    }
    UIView *xianView2 = [[UIView alloc]init];
    xianView2.backgroundColor = [UIColor colorWithRed:215/255.0 green:215/255.0 blue:215/255.0 alpha:1];
    xianView2.frame = CGRectMake(0, 170, kScreenWidth, 1);
    [BGview addSubview:xianView2];
