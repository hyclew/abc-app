/*
 * (1).加密: 第一步:strEncode(data,firstKey,secondKey,thirdKey); (2).解密:
...
function strEncode(data, firstKey, secondKey, thirdKey) {
	...
	if (data == null || data == "") {
		...
		var firstKeyBt = null, secondKeyBt = null, thirdKeyBt = null, firstLength = 0, secondLength = 0, thirdLength = 0;
